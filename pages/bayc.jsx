...
export default function BAYC({
	...
	const nftName = "BoredApeYachtClub";
...
export async function getStaticProps() {
	...
	const contractOwnerAddress = process.env.OWNER_PUBLIC_KEY_BAYC;
	const contractAddress = process.env.CONTRACT_ADDRESS_BAYC;


	//const baseURI = "https://miya.sunmiya.club";

	const baseURI = "https://cloudflare-ipfs.com/ipfs/QmeSjSinHpPnmXmspMjwiXyN6zS4E9zccariGR3jxcaWtq";
