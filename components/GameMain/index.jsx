...
{/*
	...
	*/}
	...
	1. 스테이킹 기간은 단일 싸이클 5년 고정이며, 싸이클 만기 후 각 NFT의 스테이킹 기간인 5년을 모두 채워야 Claim 신청이 가능합니다.<br></br>
	<br></br>
	2. Claim이 신청되면 관리자는 해당 내용을 바탕으로 익월초 홀더가 제출한 지갑 주소로 SML토큰을 에어드랍 합니다.<br></br>
	ex. 당월 클레임 신청자는 익월 초 NFT소각 및 SML토큰 에어드랍 순차적으로 진행<br></br>
	<br></br>
	3. 홀더가 Claim을 신청하면 해당 M.E.(메타익스플로러즈) NFT는 소각되며, 스테이킹 보상으로 2,000개의 SML토큰을 수령할 수 있게 됩ㄴ다.<br></br>
	<br></br>
	3. 싸이클 만기(5년) 이전에 Unstake 실행 시, 스테이킹은 해제되며 홀더는 M.E. NFT를 돌려받을 수 있다. 다만 그동안 마이닝 된 토큰은 모두 소멸됩니다.<br></br>
	<br></br>
	4. 스테이킹 해제로 인해 소멸된 토큰은 이후 동일한 M.E로 다시 스테이킹을 시작하여도 절대 복구되지 않으며 새로운 스테이킹 싸이클 시작 시 마이닝 수량은 0부터 시작됩니다.
	<br></br>			
						</p>
						</div>
						{/*footer*/}
			...
			{showModalUnstake ? (
				...
				>
					...
					<div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-blue-700 outline-none focus:outline-none ">
						...
						현재 Staking 중인 M.E NFT를 Unstake<br></br>하면 지금까지 마이닝 된 SML 토큰이<br></br>모두 소멸됩니다. <br></br>
	...
	선택한 NFT는 이미 Staking 중입니다.<br></br>
						...
						<button
							className={`
								my-5 w-auto self-center rounded-lg bg-regal-red px-5 py-1 font-normal text-white drop-shadow-[0_5px_5px_rgba(0,0,0,0.25)] duration-200  ease-in-out hover:bg-teal-300
							`}
							onClick={() => setShowModalStakeAlert(false)}
	...
	Staking 중이 아닙니다. Staking중인 NFT를 선택하세요.<br></br>
						...
						<button
							className={`
								my-5 w-auto self-center rounded-lg bg-regal-red px-5 py-1 font-normal text-white drop-shadow-[0_5px_5px_rgba(0,0,0,0.25)] duration-200  ease-in-out hover:bg-teal-300
							`}
							onClick={() => setShowModalUnstakeAlert(false)}
